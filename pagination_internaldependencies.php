...
$query="SELECT * FROM interdependencias_internas where clave_proceso = 1 ORDER BY clave_interdependencia_interna desc LIMIT $RegistrosAEmpezar, $RegistrosAMostrar";
...
$NroRegistros=mysql_num_rows(mysql_query("SELECT * FROM interdependencias_internas where clave_proceso=1",$con));
$PagAnt=$PagAct-1;
$PagSig=$PagAct+1;
