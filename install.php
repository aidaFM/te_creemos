...
$table = 'create table if not exists cat_directorio_personal_critico('
...
$table = 'create table if not exists proceso_personal_tipopersonal('
...
$table = 'create table if not exists cat_tipo_personal('
        . 'clave_tipo_personal int(10),'
...
$table = 'create table if not exists cat_tiempo_maximo_fs('
...
$table = 'create table if not exists cat_jefes_inmediatos('
...
$table = 'create table if not exists operacion_proceso('
        . 'clave_proceso int(10),'
        . 'hora_0 int(10),'
        . 'hora_1 int(10),'
        . 'hora_2 int(10),'
...
$table = 'create table if not exists impactos_financiero('
        . 'clave_proceso int(10) not null,'
...
$table = 'create table if not exists impactos_no_financieros('
        . 'clave_proceso int(10),'
...
$table = 'create table if not exists interdependencias_internas('
        . 'clave_proceso int(10),'
...
$table = 'create table if not exists interdependencias_externas('
        . 'clave_proceso int(10),'
...
$table = 'create table if not exists proceso_proveedor('
        . 'clave_proceso int(10),'
...
$table = 'create table if not exists cat_directorio_proveedores('
...
$table = 'create table if not exists requerimientos_bcp('
        . 'clave_proceso int(10),'
        . 'pc_on int(10),'
        . 'pc_oc int(10),'
        . 'telefono_on int(10)'
